...
var (
	...
	completeStyle    = lipgloss.NewStyle().Foreground(lipgloss.Color("8"))
	completeHitStyle = lipgloss.NewStyle().Foreground(lipgloss.Color("0")).Background(lipgloss.Color("11")).Bold(true)
)
